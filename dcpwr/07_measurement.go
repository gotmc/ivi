...
type MeasurementChannel interface {
	Measure(ctx context.Context, msrType MeasurementType) (float64, error)
	MeasureVoltage(ctx context.Context) (float64, error)
	MeasureCurrent(ctx context.Context) (float64, error)
}
