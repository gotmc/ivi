...
/*
Package kikusuipmx implements the IVI driver for the KIKUSUI PMX series of
...
// of power supplies.
type KikusuiPMX struct {
	inst     ivi.Instrument
	Channels []Channel
	ivi.Inherent
}

// New creates a new KikusuiPMX IVI Instrument. Currently, only the E3631A
...
func New(inst ivi.Instrument, reset bool) (*KikusuiPMX, error) {
